...
RSpec.describe AddressBook do
 ...
 def check_entry(entry, expected_name, expected_number, expected_email)
  ...
  describe "#bloc_leap_A_bomb" do
  it "should delete every last entry and everything in its path" do
  book.add_entry('Ada Lovelace', '010.012.1815', 'augusta.king@lovelace.com')

  book.bloc_leap_A_bomb
  ...
  describe "attributes" do
   ...
   # #3
      ...
      it "imports the 1st entry" do
        ...
        # Check the first entry
        entry_one = book.entries[0]
       check_entry(entry_one, "Ben", "999-888-7777", "benisawesome@gmail.com")
      ...
      it "imports the 2nd entry" do
            ...
            # Check the second entry
            entry_two = book.entries[1]
            check_entry(entry_two, "Blochead", "911-911-9111", "blocheadcity@gmail.com")
          end
          ...
          it "imports the 3rd entry" do
            ...
            # Check the third entry
            entry_three = book.entries[2]
            check_entry(entry_three, "Thomas", "650-248-8125", "tomhaury@gmail.com")
          end
        end
